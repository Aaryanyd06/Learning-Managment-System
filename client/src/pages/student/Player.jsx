...
const Player = () => {
  const {enrolledCourses, calulcateChapterTime} = useContext(AppContext)
  ...
  return (
    ...
    <div className='p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36'>
      ...
      <div className='md:mt-10'>
        {playerData ? (
          <div>
            <YouTube videoId={playerData.lectureUrl.split('/').pop()} iframeClassName='w-full aspect-video' className='w-full aspect-video'/>
